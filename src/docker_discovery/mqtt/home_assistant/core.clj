...
(defmethod mqtt-util/device :home-assistant
...
;; Topics ;;
;;;;;;;;;;;;
(defmethod mqtt-util/topic :home-assistant-configuration
...
(defmethod mqtt-util/topic :home-assistant-state
...
(defmethod mqtt-util/topic :home-assistant-command
  [_ _ _ host {id :id container-name :name}]
  (->> ["homeassistant"
        (str "docker_" (name host))
        (name container-name)
...
;; Payloads ;;
;;;;;;;;;;;;;;
(defmethod mqtt-util/payload :home-assistant-configuration
...
(defmethod mqtt-util/payload :home-assistant-attributes
...
(defmethod mqtt-util/payload :home-assistant-state
